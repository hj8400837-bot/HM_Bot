...
st.markdown("""
    ...
    /* Styled Input Field Containers with Borders & Icons */
    .input-field-box {
...
# --- DYNAMIC FORMS WITH GRAPHIC ICONS ---
...
# Dynamic sorting for screenshot pairs based on market type selection
...
# 4. TIMER FIELD (Sahi Timeframe Sequence)
