...
def run_advanced_ai_guard(asset):
    ...
    # BUG FIX: Indexing probabilities using the predicted class correctly instead of the array directly
    ai_confidence = int(probabilities[0][int(prediction[0])] * 100)
