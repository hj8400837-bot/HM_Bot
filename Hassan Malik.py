# app.py (requirements: streamlit, yfinance, pandas, pandas-ta)
...
# Notebook ke mutabiq Live Pairs
live_pairs_list = [
...
# Notebook ke mutabiq saare OTC Pairs
otc_pairs_list = [
...
# Button text changed to "GENERATE SIGNAL" as requested
