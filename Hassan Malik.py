...
# Custom Dark Theme CSS aur Profile Image Styling
st.markdown("""
    <style>
    .stApp {
    ...
    .profile-box img {
        ...
        height: 100%;
        object-fit: cover;
        object-position: center 20%; /* Tasveer ko face par zoom aur center karne ke liye */
    }
...
# --- 🖼️ Top Profile Section (Aapki Zoom Photo) ---
# NOTE: Yahan 'MERA_IMAGE_URL' ki jagah apni image ka live link paste karein
IMAGE_URL = "https://postimg.cc" # Sample Link

st.markdown(f"""
    <div class="profile-container">
        <div class="profile-box">
            <img src="{IMAGE_URL}" alt="Hasan Malik">
        </div>
    </div>
""", unsafe_allowed_html=True)
    ...
    with st.spinner("Checking Generator Status & Market Indicators..."):
        ...
        if "OFF" in gen_status:
            ...
            <div class="signal-box-put">
                ...
                <p style="color: #aaaaaa; margin: 5px 0;">Asset: <b>{selected_asset}</b> | TF: <b>{selected_tf}</b></p>
            ...
            if signal_type == "PUT":
                ...
                <div class="signal-box-put">
                    ...
                    <h3 style="color: #00cc88; margin-top: 15px;">🔥 AI Probability: {probability}%</h3>
                </div>
                """, unsafe_allowed_html=True)
            else:
                st.markdown(f"""
