...
# Page configurations for compact layout orientation
st.set_page_config(
...
# Main UI/UX Design Content Structure
html_content = """
<!DOCTYPE html>
<html lang='en'>
<head>
    ...
    <style>
        body { background-color: #020617; font-family: system-ui, -apple-system, sans-serif; -webkit-tap-highlight-color: transparent; }
        .neon-text-blue { text-shadow: 0 0 12px rgba(14, 165, 233, 0.7); }
        .neon-border-gold { box-shadow: 0 0 15px rgba(234, 179, 8, 0.15); border: 1px solid rgba(234, 179, 8, 0.35); }
        ...
        <div class='space-y-2.5'>
            ...
            <div class='bg-slate-950/80 p-2.5 rounded-xl border border-slate-900 grid grid-cols-3 gap-1 text-center text-[10px]'>
                ...
                <div class='border-x border-slate-800'>
                    <span class='block text-slate-500 font-semibold'>Verification</span>
